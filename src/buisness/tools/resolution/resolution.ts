export class ResolutionDevice {
     ...
     * @returns {boolean}
     */
    public isMore(width: number = window.innerWidth) {
     ...
     * @returns {boolean}
     */
    public isLess(width: number = window.innerWidth) {
     ...
     * @returns {boolean}
     */
    public isCurrent(width: number = window.innerWidth) {
